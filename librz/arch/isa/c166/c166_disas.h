...
typedef enum {
	...
	C166_BCMP_bitaddr_bitaddr = 0x2A, ///< <b>[0x2A]</b> Compare direct bit to direct bit (4 bytes)</b>
	...
	C166_ROR_Rwn_Rwm = 0x2C, ///< <b>[0x2C]</b> Rotate right direct word GPR; number of shift cycles specified by direct GPR (2 bytes)</b>
	...
	C166_BMOVN_bitaddr_bitaddr = 0x3A, ///< <b>[0x3A]</b> Move negated direct bit to direct bit (4 bytes)</b>
	// 0x3B,
	...
	C166_CMP_Rwn_Rwm = 0x40, ///< <b>[0x40]</b> Compare direct word GPR to direct GPR (2 bytes)</b>
	C166_CMPB_Rbn_Rbm = 0x41, ///< <b>[0x41]</b> Compare direct byte GPR to direct GPR (2 bytes)</b>
	C166_CMP_reg_mem = 0x42, ///< <b>[0x42]</b> Compare direct word memory to direct register (4 bytes)</b>
	C166_CMPB_reg_mem = 0x43, ///< <b>[0x43]</b> Compare direct byte memory to direct register (4 bytes)</b>
	// 0x44,
	// 0x45,
	C166_CMP_reg_data16 = 0x46, ///< <b>[0x46]</b> Compare immediate word data to direct register (4 bytes)</b>
	C166_CMPB_reg_data8 = 0x47, ///< <b>[0x47]</b> Compare immediate byte data to direct register (4 bytes)</b>
	...
	C166_BMOV_bitaddr_bitaddr = 0x4A, ///< <b>[0x4A]</b> Move direct bit to direct bit (4 bytes)</b>
	...
	C166_BOR_bitaddr_bitaddr = 0x5A, ///< <b>[0x5A]</b> OR direct bit with direct bit (4 bytes)</b>
	...
	C166_BAND_bitaddr_bitaddr = 0x6A, ///< <b>[0x6A]</b> AND direct bit with direct bit (4 bytes)</b>
	...
	C166_OR_Rwn_Rwm = 0x70, ///< <b>[0x70]</b> Bitwise OR direct word GPR with direct GPR (2 bytes)</b>
	C166_ORB_Rbn_Rbm = 0x71, ///< <b>[0x71]</b> Bitwise OR direct byte GPR with direct GPR (2 bytes)</b>
	C166_OR_reg_mem = 0x72, ///< <b>[0x72]</b> Bitwise OR direct word memory with direct register (4 bytes)</b>
	C166_ORB_reg_mem = 0x73, ///< <b>[0x73]</b> Bitwise OR direct byte memory with direct register (4 bytes)</b>
	C166_OR_mem_reg = 0x74, ///< <b>[0x74]</b> Bitwise OR direct word register with direct memory (4 bytes)</b>
	C166_ORB_mem_reg = 0x75, ///< <b>[0x75]</b> Bitwise OR direct byte register with direct memory (4 bytes)</b>
	C166_OR_reg_data16 = 0x76, ///< <b>[0x76]</b> Bitwise OR immediate word data with direct register (4 bytes)</b>
	C166_ORB_reg_data8 = 0x77, ///< <b>[0x77]</b> Bitwise OR immediate byte data with direct register (4 bytes)</b>
	...
	C166_BXOR_bitaddr_bitaddr = 0x7A, ///< <b>[0x7A]</b> XOR direct bit with direct bit (4 bytes)</b>
...
// clang-format off
typedef enum {
	C166_CC_UC = 0x00,     ///< [0D] Unconditional
	C166_CC_NET = 0x02,    ///< [1D] Not Equal 0x01 cc or 0x02 xcc
	C166_CC_EQ = 0x04,     ///< [2D] Equal
	// C166_CC_Z,          ///< [2D] Zero and Not End-of-Table
	C166_CC_NE = 0x06,     ///< [3D] Not Equal
	// C166_CC_NZ,         ///< [3D] Not Zero
	C166_CC_V = 0x08,      ///< [4D] Overflow
	C166_CC_NV = 0x0A,     ///< [5D] No Overflow
	C166_CC_N = 0x0C,      ///< [6D] Negative
	C166_CC_NN = 0x0E,     ///< [7D] Not Negative
	C166_CC_C = 0x10,      ///< [8D] Carry
	// C166_CC_ULT,        ///< [8D] Unsigned Less Than
	C166_CC_NC = 0x12,     ///< [9D] No Carry
	// C166_CC_UGE,        ///< [9D] Unsigned Greater Than or Equal
	C166_CC_SGT = 0x14,    ///< [AD] Signed Greater Than
	C166_CC_SLE = 0x16,    ///< [BD] Signed Less Than or Equal
	C166_CC_SLT = 0x18,    ///< [CD] Signed Less Than /* Not described in datasheet */
	C166_CC_SGE = 0x1A,    ///< [DD] Signed Greater Than or Equal
	C166_CC_UGT = 0x1C,    ///< [ED] Unsigned Greater Than
	C166_CC_ULE = 0x1E,    ///< [FD] Unsigned Less Than or Equal

	C166_CC_NUSR0 = 1,     ///< USR-bit 0 is cleared (*)
	C166_CC_NUSR1 = 3,     ///< USR-bit 1 is cleared (*)
	C166_CC_USR0 = 5,      ///< USR-bit 0 is set1)
	C166_CC_USR1 = 7       ///< USR-bit 1 is set1)
} C166CondCode;
