...
void rz_debug_native_fini(RzDebug *debug, void *user) {
	RZ_LOG_ERROR("Unsupported platform\n");
}
...
int rz_debug_native_continue_syscall(RzDebug *dbg, int pid, int sc) {
	RZ_LOG_ERROR("Unsupported platform\n");
	return -1;
}
...
RzList *rz_debug_native_pids(RzDebug *dbg, int pid) {
	RZ_LOG_ERROR("Unsupported platform\n");
	return NULL;
}
...
RzList *rz_debug_native_frames(RzDebug *dbg, ut64 at) {
	RZ_LOG_ERROR("Unsupported platform\n");
	return NULL;
}
...
RzList *rz_debug_native_map_get(RzDebug *dbg) {
	RZ_LOG_ERROR("Unsupported platform\n");
	return NULL;
}

RzList *rz_debug_native_modules_get(RzDebug *dbg) {
	RZ_LOG_ERROR("Unsupported platform\n");
	return NULL;
}
...
int rz_debug_native_drx(RzDebug *dbg, int n, ut64 addr, int size, int rwx, int g, int api_type) {
	RZ_LOG_ERROR("Unsupported platform\n");
	return -1;
}
